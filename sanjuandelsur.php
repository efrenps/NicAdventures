...
<head>
	<meta charset="UTF-8">
	<title>Amazing Nicadventures - San Juan del Sur</title>
...
<body>
	...
	<div class="row" id="tours">
		<div class="col-md-4 col-xs-4" id="tours-picture">
			<img src="images/sanjuandelsur/San_Juan_Del_Sur02.png" class="img-responsive" alt="Tours"/>
			<img src="images/sanjuandelsur/San_Juan_del_Sur05.png" class="img-responsive" alt="Tours"/>
		</div>
